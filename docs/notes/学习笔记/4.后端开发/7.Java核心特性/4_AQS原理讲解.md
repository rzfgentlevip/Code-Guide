---
title: 4、AQS原理讲解
icon: material-icon-theme:cabal
order: 4
author: bugcode
date: 2020-01-01T00:00:00.000Z
copyright: bugcode
createTime: 2026/01/17 16:55:00
permalink: /learning-notes/backend/java/AQS原理讲解/
---
...
![1630649642393](https://tprzfbucket.oss-cn-beijing.aliyuncs.com/hadoop/202109/03/141404-434657.png)

AQS 就是一个抽象类，主要用来构建**锁和同步器**。
...
`ReentrantLock` 默认采用**非公平锁，**因为考虑获得更好的性能，通过 `boolean` 来决定是否用公平锁（传入 true 用公平锁）。
